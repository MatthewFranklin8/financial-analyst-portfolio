...
Projects
1. Netflix FP&A Model & Variance Analysis

A driver-based revenue forecast (subscribers × ARPU by region) built from Netflix's 10-K/10-Q/8-K filings, with a quarterly variance bridge comparing forecast to actuals and a board-style narrative memo. This is the core FP&A deliverable in the portfolio — closest to what an internal finance team produces each quarter.

2. Hospital Utilization Dashboard
